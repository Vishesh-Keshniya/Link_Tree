...
function usePieSeries() {
  ...
  return React56.useMemo(() => series.pie, [series.pie]);
}
function useLineSeries() {
  const series = useSeries();
  return React56.useMemo(() => series.line, [series.line]);
}
...
function useScatterSeries() {
  const series = useSeries();
  return React56.useMemo(() => series.scatter, [series.scatter]);
}
...
function CartesianProvider(props) {
  ...
  const xValues = React58.useMemo(() => computeAxisValue({
    drawingArea,
    formattedSeries,
    axis: xAxis,
  ...
  const yValues = React58.useMemo(() => computeAxisValue({
    drawingArea,
    formattedSeries,
    axis: yAxis,
...
var InteractionContext = React60.createContext({
  item: null,
  axis: {
    x: null,
    y: null
...
function InteractionProvider(props) {
  ...
  const [data, dispatch] = React60.useReducer(dataReducer, {
    item: null,
    axis: {
      x: null,
      y: null
  ...
  const value = React60.useMemo(() => _extends({}, data, {
    dispatch
  }), [data]);
...
var HighlightedContext = React61.createContext({
  isInitialized: false,
  data: {
...
function HighlightedProvider({
  ...
  const series = useSeries();
  const seriesById = React62.useMemo(() => {
  ...
  const providerValue = React62.useMemo(() => {
    return {
      isInitialized: true,
      data: {
        highlightScope,
...
function useHighlighted() {
  const {
    isInitialized,
    data
  } = React63.useContext(HighlightedContext);
  if (!isInitialized) {
...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react16.forwardRef)((givenProps, givenRef) => {
    ...
    return React66.createElement(Component, { ...usedProps, ref });
  });
};
...
var SpringContext = ({
  ...
  const { Provider } = ctx;
  return React67.createElement(Provider, { value: props }, children);
};
...
var useStringInterpolator = (path) => {
  ...
  const interpolator = React68.useMemo(() => memoryRef.previousPath ? string_default(memoryRef.previousPath, memoryRef.currentPath) : () => memoryRef.currentPath, [memoryRef.currentPath, memoryRef.previousPath]);
  return interpolator;
};
...
function useXAxis(identifier2) {
  const {
    xAxis,
    xAxisIds
  } = useCartesianContext();
  const id = typeof identifier2 === "string" ? identifier2 : xAxisIds[identifier2 ?? 0];
  return xAxis[id];
}
function useYAxis(identifier2) {
  const {
    yAxis,
    yAxisIds
  } = useCartesianContext();
  const id = typeof identifier2 === "string" ? identifier2 : yAxisIds[identifier2 ?? 0];
  return yAxis[id];
}
...
function useXScale(identifier2) {
  const axis = useXAxis(identifier2);
  return axis.scale;
}
function useYScale(identifier2) {
  const axis = useYAxis(identifier2);
  return axis.scale;
}

// node_modules/@mui/x-charts/hooks/useColorScale.js
var React70 = __toESM(require_react());
function useXColorScale(identifier2) {
  const {
    xAxis,
    xAxisIds
  } = useCartesianContext();
...
function useYColorScale(identifier2) {
  const {
    yAxis,
    yAxisIds
  } = useCartesianContext();
...
function useZColorScale(identifier2) {
  var _a;
  const {
    zAxis,
    zAxisIds
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime28.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index) => {
      ...
      return (0, import_jsx_runtime28.jsxs)(React75.Fragment, {
...
function useChartGradient() {
  const {
    chartId
  } = React77.useContext(DrawingContext);
  return React77.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
...
var AnimationContext = React78.createContext({
  isInitialized: false,
  data: {
...
function AnimationProvider(props) {
  ...
  const [skipAnimation2, setSkipAnimation] = React79.useState(isAnimationDisabledEnvironment || void 0);
  useIsomorphicLayoutEffect(() => {
    var _a;
...
function useSkipAnimation(skipAnimation2) {
  const {
    isInitialized,
    data
  } = React80.useContext(AnimationContext);
  if (!isInitialized) {
...
var useDefaultizeAxis = (inXAxis, inYAxis, dataset) => {
  const xAxis = React87.useMemo(() => defaultizeAxis(inXAxis, dataset, "x"), [inXAxis, dataset]);
  const yAxis = React87.useMemo(() => defaultizeAxis(inYAxis, dataset, "y"), [inYAxis, dataset]);
  return [xAxis, yAxis];
};
...
var useChartContainerProps = (props, ref) => {
  ...
  const svgRef = React88.useRef(null);
...
var ChartContainer = React89.forwardRef(function ChartContainer2(props, ref) {
  const {
    children,
    drawingProviderProps,
    seriesProviderProps,
...
var useChartContainerDimensions = (inWidth, inHeight, resolveSizeBeforeRender) => {
  const stateRef = React90.useRef({
    displayError: false,
    initialCompute: true,
    computeRun: 0
  });
  const rootRef = React90.useRef(null);
  const [width2, setWidth] = React90.useState(0);
  const [height2, setHeight] = React90.useState(0);
  const computeSize = React90.useCallback(() => {
...
var ResponsiveChartContainer = React91.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    hasIntrinsicSize,
    chartContainerProps,
    resizableChartContainerProps
...
function MarkElement(props) {
  ...
  return (0, import_jsx_runtime40.jsx)(MarkElementPath, _extends({}, other, {
    style: {
      transform: to2([position3.x, position3.y], (pX, pY) => `translate(${pX}px, ${pY}px)`),
      transformOrigin: to2([position3.x, position3.y], (pX, pY) => `${pX}px ${pY}px`)
    },
    ownerState,
    className: classes.root,
...
function ChartsText(props) {
  ...
  const wordsByLines = React95.useMemo(() => getWordsByLines({
    style: style4,
  ...
  return (0, import_jsx_runtime42.jsx)("text", _extends({}, textProps, {
    ...
    dominantBaseline,
    style: style4,
    children: wordsByLines.map((line2, index) => (0, import_jsx_runtime42.jsx)("tspan", {
      x,
...
function useMounted(defer = false) {
  const [mountedState, setMountedState] = React96.useState(false);
  useEnhancedEffect_default(() => {
    if (!defer) {
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime45.jsxs)(React99.Fragment, {
...
var Portal = React100.forwardRef(function Portal2(props, forwardedRef) {
  const {
    children,
    container,
    disablePortal = false
  } = props;
  const [mountNode, setMountNode] = React100.useState(null);
  const handleRef = useForkRef(React100.isValidElement(children) ? getReactElementRef(children) : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (React100.isValidElement(children)) {
      const newProps = {
        ref: handleRef
      };
      return React100.cloneElement(children, newProps);
    }
    return children;
  }
...
var PopperTooltip = React101.forwardRef(function PopperTooltip2(props, forwardedRef) {
  const {
    anchorEl,
    children,
    direction,
  ...
  const popperRef = React101.useRef(null);
  const handlePopperRef = useForkRef(popperRef, popperRefProp);
  const handlePopperRefRef = React101.useRef(handlePopperRef);
  useEnhancedEffect_default(() => {
    handlePopperRefRef.current = handlePopperRef;
  }, [handlePopperRef]);
  React101.useImperativeHandle(popperRefProp, () => popperRef.current, []);
  const rtlPlacement = flipPlacement(initialPlacement, direction);
  const [placement, setPlacement] = React101.useState(rtlPlacement);
  const [resolvedAnchorElement, setResolvedAnchorElement] = React101.useState(resolveAnchorEl(anchorEl));
  React101.useEffect(() => {
...
var Popper = React101.forwardRef(function Popper2(props, forwardedRef) {
  const {
    anchorEl,
    children,
...
var Popper3 = React105.forwardRef(function Popper4(inProps, ref) {
  const isRtl = useRtl();
...
function NoSsr(props) {
  ...
  const [mountedState, setMountedState] = React106.useState(false);
  useEnhancedEffect_default(() => {
    if (!defer) {
      setMountedState(true);
    }
...
function useMouseTracker() {
  const svgRef = useSvgRef();
  const [mousePosition, setMousePosition] = React107.useState(null);
  React107.useEffect(() => {
    const element = svgRef.current;
    if (element === null) {
      return () => {
...
var Typography = React110.forwardRef(function Typography2(inProps, ref) {
  const {
    color: color3,
    ...themeProps
  } = useDefaultProps2({
...
function ChartsAxisTooltipContent(props) {
  ...
  const {
    zAxisIds,
    zAxis
  } = React112.useContext(ZAxisContext);
  const series = useSeries();
  const colorProcessors = useColorProcessor();
  const USED_AXIS_ID = isXaxis ? xAxisIds[0] : yAxisIds[0];
  const relevantSeries = React112.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React112.useMemo(() => {
...
function ChartsTooltip(inProps) {
  ...
  const {
    item,
    axis
  } = React113.useContext(InteractionContext);
...
function useItemTooltip() {
  ...
  const {
    item
  } = React114.useContext(InteractionContext);
  const series = useSeries();
  const {
    xAxis,
    yAxis,
  ...
  const {
    zAxis,
    zAxisIds
  } = React114.useContext(ZAxisContext);
  const colorProcessors = useColorProcessor();
  const xAxisId = series.xAxisId ?? series.xAxisKey ?? xAxisIds[0];
  const yAxisId = series.yAxisId ?? series.yAxisKey ?? yAxisIds[0];
  const zAxisId = series.zAxisId ?? series.zAxisKey ?? zAxisIds[0];
  ...
  const relevantSeries = Object.keys(series).filter(isCartesianSeriesType).flatMap((seriesType) => {
    ...
    return seriesOfType.seriesOrder.map((seriesId) => {
      ...
      if (axisKey === void 0 || axisKey === USED_AXIS_ID) {
        ...
        const yAxisId = providedYAxisId ?? yAxisIds[0];
        const zAxisId = seriesToAdd.zAxisId ?? seriesToAdd.zAxisKey ?? zAxisIds[0];
        const color3 = ((_a = colorProcessors[seriesType]) == null ? void 0 : _a.call(colorProcessors, seriesToAdd, xAxis[xAxisId], yAxis[yAxisId], zAxisId && zAxis[zAxisId])(dataIndex)) ?? "";
...
function LegendPerItem(props) {
  ...
  const theme = useTheme5();
  const drawingArea = useDrawingArea();
  const labelStyle = React117.useMemo(
  ...
  const padding2 = React117.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React117.useCallback((label, inStyle = {}) => {
  ...
  const [itemsWithPosition, legendWidth, legendHeight] = React117.useMemo(() => legendItemPlacements(itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap), [itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap]);
  const gapX = React117.useMemo(() => {
...
function useAxis({
  ...
  const {
    zAxis,
    zAxisIds
  } = React120.useContext(ZAxisContext);
...
function ContinuousColorLegend(props) {
  ...
  return (0, import_jsx_runtime61.jsxs)(React121.Fragment, {
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime63.jsxs)(React123.Fragment, {
  ...
  return (0, import_jsx_runtime66.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ...
      return groupIds.flatMap((seriesId) => {
        ...
        const colorGetter = getColor_default3(series[seriesId], xAxis[xAxisId], yAxis[yAxisId]);
        return (0, import_jsx_runtime66.jsx)(Element2, _extends({
          id: seriesId,
...
function ChartsGridVertical(props) {
  ...
  return (0, import_jsx_runtime67.jsx)(React127.Fragment, {
    children: xTicks.map(({
      value,
      offset: offset2
...
function ChartsGridHorizontal(props) {
  ...
  return (0, import_jsx_runtime68.jsx)(React128.Fragment, {
    children: yTicks.map(({
      value,
      offset: offset2
...
function ChartsOnAxisClickHandler(props) {
  ...
  const {
    axis
  } = React130.useContext(InteractionContext);
  const {
    xAxisIds,
    xAxis,
    yAxisIds,
  ...
  return (0, import_jsx_runtime70.jsx)(React130.Fragment, {});
}
...
var LineChart = React134.forwardRef(function LineChart2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiLineChart"
  });
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-QGVRMIXR.js.map
